...
{{- default .Values.global.participantId .Values.controlplane.edc.iam.keyAliasOverwrite }}
{{- end -}}
...
{{/*
Generates the identityhub labels
*/}}
{{- define "identityhub.labels" -}}
app.kubernetes.io/name: connector
app.kubernetes.io/instance: {{ .Release.Name }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
app.kubernetes.io/component: identityhub
app.kubernetes.io/managed-by: {{ .Release.Service }}
helm.sh/chart: {{ .Chart.Name }}-{{ .Chart.Version }}
{{- end -}}

{{/*
Generates identityhub labels to match immutable field like deployment templates or services
*/}}
{{- define "identityhub.matchLabels" -}}
app.kubernetes.io/name: connector
app.kubernetes.io/instance: {{ .Release.Name }}
app.kubernetes.io/component: identityhub
{{- end -}}
