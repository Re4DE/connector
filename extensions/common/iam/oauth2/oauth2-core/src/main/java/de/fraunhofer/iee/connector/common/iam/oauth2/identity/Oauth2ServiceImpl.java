...
import org.eclipse.edc.token.spi.*;
...
public class Oauth2ServiceImpl implements IdentityService {
    ...
    private final String privateKeySupplier;
     ...
     */
    public Oauth2ServiceImpl(String tokenUrl, TokenGenerationService tokenGenerationService, String privateKeyIdSupplier,
