...
public class CatalogNodeDirectoryExtension implements ServiceExtension {
    ...
    public void initialize(ServiceExtensionContext context) {
        if (this.enabled) {
            ...
            var targetNodeDirectory = new CatalogNodeDirectory(this.httpclient, this.identityService, context.getMonitor(), this.connectorRegistryUrl, this.typeManager.getMapper());
