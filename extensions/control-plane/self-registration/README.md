...
tries to issue a Membership Credential or other relevant credentials, if enabled.
...
| edc.registration.marketPartner.issuance.enabled | false                              | Switch to enable self issuance of a Market Partner Credential. Default is false, if activate this participant is part of the regulated market communication                                           |
